import unittest
from media_management_scripts.support.episode_finder import EpisodePart, calculate_new_filenames, extract

class ExtractTestCase(unittest.TestCase):

    def assertExtract(self, test_str, expected_season, expected_episode, expected_part, use101=False):
...
class RenameTestCase(unittest.TestCase):
    ...
    def test_rename(self):
        ...
        source, season_episode, dest = next(calculate_new_filenames(episodes, output_dir='', use_season_folders=False, show_name=None))
    ...
    def test_rename_output_dir(self):
        ...
        source, season_episode, dest = next(calculate_new_filenames(episodes, output_dir=output_dir, use_season_folders=False, show_name=None))
        self.assertEqual(path, source)
    ...
    def test_rename_with_season(self):
        ...
        source, season_episode, dest = next(calculate_new_filenames(episodes, output_dir='', use_season_folders=True, show_name=None))
        self.assertEqual(path, source)
    ...
    def test_rename_with_show(self):
        ...
        source, season_episode, dest = next(calculate_new_filenames(episodes, output_dir='', use_season_folders=False, show_name=show_name))
        self.assertEqual(path, source)
    ...
    def test_rename_with_show_and_season(self):
        ...
        source, season_episode, dest = next(calculate_new_filenames(episodes, output_dir='', use_season_folders=True, show_name=show_name))
        self.assertEqual(path, source)
        self.assertEqual(show_name+'/Season 01/'+show_name+' - S01E01 - Test.mp4', dest)
