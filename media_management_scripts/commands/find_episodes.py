...
from media_management_scripts.support.episode_finder import find_episodes, calculate_new_filenames
...
class FindEpisodesCommand(SubCommand):
    ...
    def build_argparse(self, subparser):
        ...
        find_episode_parser.add_argument('--show', default=None, type=str, dest='show', help='Show name')
    ...
    def subexecute(self, ns):
        ...
        table = sorted(list(calculate_new_filenames(episodes, out_dir, season_folders, show_name)))
